export default function Footer() {
  return (
    <footer className="bg-univille-green text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p>Endereço: Rua Paulo Malschitzki, 10</p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p>Telefone: (47) 3461-9000</p>
              <p>Email: contato@univille.edu.br</p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 text-center text-sm">
          <p>Desenvolvido na Região - 2023</p>
        </div>
      </div>
    </footer>
  )
